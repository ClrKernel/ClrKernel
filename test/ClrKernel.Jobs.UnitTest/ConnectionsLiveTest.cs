...
/// <para>
/// Set <c>CLRKERNEL_JOBS_TEST_SQL</c> to a connection string. Missing, these are
...
/// CLRKERNEL_JOBS_TEST_SQL='Server=localhost,51433;Database=master;User Id=sa;Password=DevOnly!Passw0rd;TrustServerCertificate=True' \
