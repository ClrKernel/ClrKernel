...
const studioPages = {
  ...
  'Git remotes': { slug: 'git-remotes', order: 7 },
  'Test → prod with git': { slug: 'promotion', order: 8 },
  'Getting around': { slug: 'getting-around', order: 9 },
  Overview: { slug: 'dashboard', order: 10, title: 'The dashboard' },
  Monitoring: { slug: 'monitoring', order: 11 },
  ...
  Notifications: { slug: 'notifications-page', order: 12, title: 'The Notifications page' },
  'Running something again': { slug: 'rerunning', order: 13 },
  'The notebook editor': { slug: 'editor', order: 14 },
  Connections: { slug: 'connections', order: 15 },
  'Notification channels': { slug: 'channels', order: 16 },
  'Where things are stored': { slug: 'storage', order: 17 },
  Retention: { slug: 'retention', order: 18 },
  API: { slug: 'api', order: 19 },
  'Configuration reference': { slug: 'configuration', order: 20 },
  Settings: { slug: 'settings', order: 21 },
  Docker: { slug: 'docker-quickstart', order: 22, title: 'Docker quickstart' },
  'Not there yet': { slug: 'not-there-yet', order: 24 },
...
const docsPages = {
  ...
  'docker.md': { dir: 'studio', slug: 'docker', order: 23, title: 'Docker' },
};
