      ...
      <TooltipTrigger asChild>
        <Link
          ...
          className={[
            ...
            'relative flex size-10 items-center justify-center rounded-md outline-none transition-colors',
...
export function Rail() {
  return (
    <nav
      aria-label="Sections"
      className="flex w-12 flex-col items-center gap-1 border-r border-border bg-surface-rail py-2"
    >
      <Tooltip>
        <TooltipTrigger asChild>
          <Link
            ...
            className="mb-1 flex size-8 items-center justify-center rounded-md bg-primary text-primary-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-surface-rail"
          >
