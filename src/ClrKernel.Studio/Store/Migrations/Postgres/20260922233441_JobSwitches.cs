    ...
    protected override void Up(MigrationBuilder migrationBuilder) {
        migrationBuilder.CreateTable(
            ...
            columns: table => new {
                ...
                path = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                active = table.Column<bool>(type: "boolean", nullable: false),
                paused_until = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
