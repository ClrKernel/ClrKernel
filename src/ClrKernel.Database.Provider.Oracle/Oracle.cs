...
/// <summary>
/// Oracle provider entry point. Returns the same fluent <see cref="DataSource"/> as the
...
public static class Oracle {
    ...
    public static DataSource FromConnectionString(string connectionString, string name = "oracle") {
    ...
    private static DataSource Build(string name, string connectionString) =>
        new DataSource(name, () => new OracleClient.OracleConnection(connectionString));
}
